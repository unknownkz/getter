...
@kasta_cmd(pattern="repeat(?: |$)(.*)")
async def _repeat(e):
    count = e.pattern_match.group(1) or 1
    rep = await e.get_reply_message()
    if not e.is_reply or not (hasattr(rep, "text") and rep.text):
        return await e.try_delete()
    try:
...
@kasta_cmd(pattern="(b64encode|b64e)(?: |$)(.*)")
...
@kasta_cmd(pattern="(b64decode|b64d)(?: |$)(.*)")
...
@kasta_cmd(pattern="(morse|unmorse)(?: |$)(.*)")
async def _morse(e):
...
@kasta_cmd(pattern="(roman|unroman)(?: |$)(.*)")
async def _roman(e):
    Kst = e.pattern_match.group(2)
    if not Kst and e.is_reply:
        Kst = (await e.get_reply_message()).text
